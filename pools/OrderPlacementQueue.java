...
public class OrderPlacementQueue {
    ...
    public OrderPlacementQueue(int size ){
        this.orderQueue = new int[size];
    ...
    public void putOrder(){
        ...
        lock.lock();
        try{
        while(orderCount==this.orderQueue.length)
        {
            full.await();   
                }
    ...
    public int getOrder(){
        ...
        orderId = orderQueue[queueHead];
        queueHead = (queueHead +1) % orderQueue.length;
        orderCount --;
